        ...
        <main className="flex flex-col items-center min-h-screen bg-page-bg">
            ...
            <div className="w-full max-w-[375px]">
                ...
                <div className="w-full bg-timer-yellow-bg py-3 flex justify-center px-5">
                    <div className="flex items-center w-full justify-between">
                        ...
                        />
                            ...
                            Reserved price for:
                                <span className="text-[24px] font-bold text-summary-purple ml-1">
                                <CountdownTimer /> 
                            </span>
                        </span>
                    </div>
                ...
                <div className="w-full px-5 py-8">
                    ...
                    <h1 className="text-[24px] font-bold leading-tight mt-10 mb-6  ">
                        Your personalized Alcohol-Free Plan is ready!
                    </h1>

                    <div className="flex flex-row items-center justify-between">

                            <div className="flex items-center w-[147.5px] gap-4">
                                <Image 
                                    src="/icons/Frame.svg" 
                            ...
                            <div className="flex items-center w-[147.5px] gap-2">
                                <Image 
                    ...
                    <div className="mt-6">
                        <h2 className="text-[24px] font-bold font-weight-700">
